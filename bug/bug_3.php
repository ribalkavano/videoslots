<div>
          ...
          <span class="fw-bold">Severity: </span> Major
        <br>
          <span class="fw-bold">Priority: </span> Low
        <br>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-8 themed-grid-col">
                <div class="h-100 p-2 bg-light border rounded-1">
                    <p>1. Open the <a href="https://www.videoslots.com">Videoslots</a> web site</p>
                    <p>2. Click on the "Register" button</p>
                    <p>3. Right click on the "Privacy Policy" below the form</p>
                    <p>4. Select "Open link in new tab" option</p>
                </div>
            </div>
          </div>
